...
public class FilterAndDeleteController {
	...
	@ResponseBody
	public String filterMessages(@RequestParam String mailChecked,
			HttpSession session) {
	...
	@ResponseBody
	public String filterMessagesGetMethod(HttpSession session) {
	...
	@ResponseBody
	public String deleteMessages(@RequestParam String msgToDelete,HttpSession session){
