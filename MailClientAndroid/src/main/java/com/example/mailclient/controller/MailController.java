...
public class MailController {
	...
	@ResponseBody
	public String addNewMail(@RequestParam String mail,
	...
	@RequestMapping(value = "homepage/sendmail", method = { RequestMethod.POST }, params = {
			"sender", "recipient" })
	@ResponseBody
	public String sendEmailtoReceiver(@RequestParam(value = "sender") String sender,@RequestParam(value = "recipient") String recipient,
	...
	@RequestMapping(value = "homepage/sendmail", method = RequestMethod.GET, params = {
			"sender", "recipient" })
	@ResponseBody
	public String sendEmailtoReceiverGetMethod(
