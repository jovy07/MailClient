   		...
   		<div id="emailMessage">
			...
			<c:forEach items="${message}" var="msg">
				<c:forEach items="${msg }" var="msgItem">				
					<input type="checkbox" name="msgToDelete" value="${msgItem.key }" ><a id="linkSubjects" href="<c:url  value="messagebox/${msgItem.key }"/>" style="text-decoration: none; color: black;">${msgItem.key }</a><br><br>
				</c:forEach>
